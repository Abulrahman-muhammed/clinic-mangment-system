    ...
    <div class="row">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="avatar avatar-sm bg-light-primary text-primary rounded mr-3 mt-1 text-center" style="width: 32px; height: 32px; line-height: 32px;">
                    ...
                    <div class="d-flex mb-3">
                        <div class="avatar avatar-sm bg-light-success text-success rounded mr-3 mt-1 text-center" style="width: 32px; height: 32px; line-height: 32px;">
                    ...
                    @if($patient->address)
                    <div class="d-flex">
                        <div class="avatar avatar-sm bg-light-info text-info rounded mr-3 mt-1 text-center" style="width: 32px; height: 32px; line-height: 32px;">
                ...
                <div class="card-body">
                    <div class="row no-gutters mb-4">
                        <div class="col-6 border-right px-2">
                            ...
                            <p class="font-weight-bold mb-0">{{ $patient->date_of_birth ? \Carbon\Carbon::parse($patient->date_of_birth)->format('M d, Y') : '—' }}</p>
                        </div>
                        <div class="col-6 px-3">
                            <small class="text-muted d-block">Age</small>
                            <p class="font-weight-bold mb-0">{{ $patient->date_of_birth ? \Carbon\Carbon::parse($patient->date_of_birth)->age . ' Years' : '—' }}</p>
                        </div>
                    </div>
                    <div class="row no-gutters mb-4">
                        <div class="col-6 border-right px-2">
                        ...
                        <div class="col-6 px-3">
                            ...
                            <span class="badge badge-danger px-2"><i class="fe fe-droplet mr-1"></i>{{ $patient->blood_type ?? 'N/A' }}</span>
                        </div>
                    </div>
        ...
        <div class="col-lg-8">
            <div class="row mb-4">
                @php
                    $statCards = [
                        ['label' => 'Completed', 'val' => $stats['completed_appointments'], 'icon' => 'check-circle', 'color' => 'success'],
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-xs mr-2 bg-light rounded-circle text-center" style="width:24px; height:24px;"><i class="fe fe-user small"></i></div>
                                        <div>
                                            <div class="font-weight-600 small">Dr. {{ $appointment->doctor->user->name ?? 'N/A' }}</div>
                                            <div class="text-muted x-small" style="font-size: 0.75rem;">{{ $appointment->doctor->major->name ?? 'General' }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="text-center py-4 text-muted small">No billing history available.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
